#!/usr/bin/env python3
"""
Store fixation crops from scene images.

This script extracts and saves individual fixation crop images from scene presentations.
Crops are stored as individual PNG files in organized directories by crop size.

Usage:
    python store_fixation_crops.py --subjects 1 2 3 --sessions 1 2 --data-path /path/to/data
    python store_fixation_crops.py --subject 1 --session 1 --crop-size 112 112
    python store_fixation_crops.py --all-subjects --all-sessions
...
# Initialize logger
logger = get_logger('scripts.store_fixation_crops')
...
Examples:
    ...
    python store_fixation_crops.py --subjects 1 2 3 --sessions 1 2
    
    # Process single subject-session with custom crop size
    python store_fixation_crops.py --subject 1 --session 1 --crop-size 224 224
